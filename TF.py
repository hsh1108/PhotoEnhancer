...
def getInputPhoto(file_name):
    ...
    if checkValidImg(input_img):
        ...
        os.rename(FLAGS['folder_input'] + file_name_without_ext + '.png', FLAGS['folder_input'] + file_name)
        return file_name
    else:
        return None
...
def processImg(file_in_name, file_out_name_without_ext):
    ...
    os.rename(FLAGS['folder_test_img'] + file_out_name_without_ext + '.png', enhance_img_file_path)
